...
from CMGTools.DiMuons.samples.mc import BToJPsiK as inputSample
...
# inputSample.files = inputSample.files[:4]
...
'''
heppy_batch.py -o production_bjpsimm_k bjpsimmk_mc_cfg.py -B -b 'run_condor_simple.sh -t 1200 ./batchScript.sh'
'''
